            ...
            <ScrollView contentContainerStyle={styles.scrollViewContentStyle}>
                <View style={styles.payerContainer}>
                    <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                        <View style={{ width: 40, height: 40, borderRadius: 20, backgroundColor: colors.white }} />
                        <Text style={{ marginLeft: 10, color: colors.white }}>Trả bởi <Text style={{ fontWeight: 'bold' }}>Hào Lương</Text></Text>
                    </View>
